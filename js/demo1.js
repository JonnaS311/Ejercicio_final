...
function createLandscape(params){
  ...
  function sceneSetup(){
    ...
    escena.fog = new THREE.Fog(fogColor, 0, 200);
  ...
  function render(){
    ...
    terrain.material.uniforms.distortCenter.value = map(mouse.xDamped, 0, ancho, -0.1, 0.1);
    terrain.material.uniforms.roadWidth.value = map(mouse.yDamped, 0, alto, -0.5, 2.5);
